    ...
    public function run(): void
    {
        $products = [
            ...
            [
                ...
                'unit' => 'dus', 'weight' => 12.00, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 2], ['unit' => 'pcs', 'qty' => 3]],
                'min_purchase' => 1, 'base_cost' => 180000.00, 'sell_price' => 198000.00,
            ...
            [
                ...
                'unit' => 'dus', 'weight' => 12.00, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 2], ['unit' => 'pcs', 'qty' => 3]],
                'min_purchase' => 1, 'base_cost' => 170000.00, 'sell_price' => 188000.00,
                'min_stock' => 20, 'is_active' => true,
            ],
            // Beras (category_id: 2)
            [
                ...
                'unit' => 'karung', 'weight' => 25.00, 'price_breakdowns' => null,
                'min_purchase' => 1, 'base_cost' => 310000.00, 'sell_price' => 335000.00,
            ...
            [
                ...
                'unit' => 'karung', 'weight' => 25.00, 'price_breakdowns' => null,
                'min_purchase' => 1, 'base_cost' => 330000.00, 'sell_price' => 358000.00,
                'min_stock' => 50, 'is_active' => true,
            ],
            // Gula (category_id: 3)
            [
                ...
                'unit' => 'dus', 'weight' => 24.00, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 4], ['unit' => 'pcs', 'qty' => 6]],
                'min_purchase' => 1, 'base_cost' => 360000.00, 'sell_price' => 396000.00,
            ...
            [
                ...
                'unit' => 'dus', 'weight' => 12.00, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 2], ['unit' => 'pcs', 'qty' => 6]],
                'min_purchase' => 1, 'base_cost' => 142000.00, 'sell_price' => 156000.00,
            ...
            [
                ...
                'unit' => 'dus', 'weight' => 5.00, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 4], ['unit' => 'pcs', 'qty' => 10]],
                'min_purchase' => 1, 'base_cost' => 104000.00, 'sell_price' => 112000.00,
            ...
            [
                ...
                'brand' => 'Indomie', 'category_id' => 5, 'supplier_id' => 1,
                'unit' => 'dus', 'weight' => 5.00, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 4], ['unit' => 'pcs', 'qty' => 10]],
                'min_purchase' => 1, 'base_cost' => 100000.00, 'sell_price' => 108000.00,
            ...
            [
                ...
                'unit' => 'dus', 'weight' => 3.00, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 12], ['unit' => 'pcs', 'qty' => 10]],
                'min_purchase' => 1, 'base_cost' => 185000.00, 'sell_price' => 204000.00,
                'min_stock' => 30, 'is_active' => true,
            ],
            // Susu (category_id: 7)
            [
                ...
                'unit' => 'dus', 'weight' => 6.00, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 4], ['unit' => 'pcs', 'qty' => 6]],
                'min_purchase' => 1, 'base_cost' => 96000.00, 'sell_price' => 108000.00,
                'min_stock' => 30, 'is_active' => true,
            ],
            ...
            [
                ...
                'unit' => 'dus', 'weight' => 15.00, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 4], ['unit' => 'pcs', 'qty' => 6]],
                'min_purchase' => 1, 'base_cost' => 58000.00, 'sell_price' => 65000.00,
                'min_stock' => 50, 'is_active' => true,
            ],
            ...
            [
                ...
                'unit' => 'dus', 'weight' => 10.80, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 2], ['unit' => 'pcs', 'qty' => 6]],
                'min_purchase' => 1, 'base_cost' => 192000.00, 'sell_price' => 216000.00,
                'min_stock' => 20, 'is_active' => true,
            ],
            [
                ...
                'unit' => 'dus', 'weight' => 9.60, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 2], ['unit' => 'pcs', 'qty' => 6]],
                'min_purchase' => 1, 'base_cost' => 120000.00, 'sell_price' => 138000.00,
                'min_stock' => 20, 'is_active' => true,
            ],
            ...
            [
                ...
                'unit' => 'dus', 'weight' => 7.20, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 2], ['unit' => 'pcs', 'qty' => 6]],
                'min_purchase' => 1, 'base_cost' => 156000.00, 'sell_price' => 174000.00,
                'min_stock' => 15, 'is_active' => true,
            ],
            // Contoh produk dengan VARIAN wajib pilih (Warna/Rasa) — TP Buncis, mengikuti
            // contoh breakdown harga di spesifikasi: 1 Sak = 8 Bal, 1 Bal = 20 Pcs.
            [
                'sku' => 'PRD-0016', 'barcode' => '8991234560016',
                'name' => 'TP Buncis', 'slug' => 'tp-buncis',
                'brand' => 'TP', 'category_id' => 10, 'supplier_id' => null,
                'unit' => 'sak', 'weight' => 20.00, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 8], ['unit' => 'pcs', 'qty' => 20]],
                'min_purchase' => 1, 'base_cost' => 290000.00, 'sell_price' => 314500.00,
                'min_stock' => 10, 'is_active' => true,
            ],
            [
                'sku' => 'PRD-0017', 'barcode' => '8991234560023',
                'name' => 'Power F Serbaguna', 'slug' => 'power-f-serbaguna',
                'brand' => 'Power F', 'category_id' => 9, 'supplier_id' => null,
                'unit' => 'dus', 'weight' => 8.00, 'price_breakdowns' => [['unit' => 'bal', 'qty' => 4], ['unit' => 'pcs', 'qty' => 12]],
                'min_purchase' => 1, 'base_cost' => 88000.00, 'sell_price' => 98000.00,
                'min_stock' => 15, 'is_active' => true,
            ],
        ];
        ...
        // Varian wajib pilih untuk Power F (contoh dari spesifikasi: Ungu, Merah, Kuning)
        $powerF = Product::where('sku', 'PRD-0017')->first();
        if ($powerF) {
            foreach (['Ungu', 'Merah', 'Kuning'] as $i => $color) {
                ProductVariant::firstOrCreate(
                    ['product_id' => $powerF->id, 'name' => $color],
                    ['extra_price' => 0, 'stock' => 25, 'is_active' => true, 'sort_order' => $i]
                );
            }
        }
    }
