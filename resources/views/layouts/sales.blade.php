    ...
    <div class="max-w-lg mx-auto min-h-screen bg-slate-50 dark:bg-slate-900 relative flex flex-col shadow-xl">
        ...
        <header class="sticky top-0 z-30 safe-top bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
            <div class="flex items-center gap-3 px-4 h-14">
                ...
                @elseif (request()->routeIs('sales.orders.edit'))
                    <a href="{{ url()->previous() }}" wire:navigate class="p-1.5 -ml-1.5 text-slate-500 dark:text-slate-400 rounded-lg active:bg-slate-100 dark:active:bg-slate-800">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                    </a>
                    <span class="text-sm font-bold text-slate-800 dark:text-white">Edit Order</span>
                ...
                <div class="ml-auto flex items-center gap-1">
                    <button @click="$store.theme.toggle()" class="p-2 text-slate-400 hover:text-primary-600 rounded-lg active:bg-slate-100 dark:active:bg-slate-800">
                        <svg x-show="!$store.theme.dark" class="w-4.5 h-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path></svg>
